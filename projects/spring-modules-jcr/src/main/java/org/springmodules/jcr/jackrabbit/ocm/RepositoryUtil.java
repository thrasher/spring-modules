...
public class RepositoryUtil {
	 ...
	 * 
	 * @throws RepositoryException
	 *             when it is not possible to get the repository. Before calling
	 *             this method, the repository has to be registered (@see
	 *             RepositoryUtil#registerRepository(String, String, String)
	 */
