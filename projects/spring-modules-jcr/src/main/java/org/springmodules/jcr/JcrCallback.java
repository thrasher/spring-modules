...
/**
 * Callback interface for Jcr code. To be used with JcrTemplate's execute
 * method, assumably often as anonymous classes within a method implementation.
 * The typical implementation will call Session.get/move/query to perform some
...
public interface JcrCallback {
	 ...
	 * {@link javax.jcr.JCRSession}. It is not responsible for logging out of
	 * the <code>Session</code> or handling transactions.
	 * 
