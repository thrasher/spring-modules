 ...
 * like JcrSessionFactory. The required property is sessionFactory.
 * 
 * <p>
...
public abstract class JcrAccessor implements InitializingBean {
	...
	/**
	 * Eagerly initialize the session holder provider, creating a default one if
	 * one is not set.
	 */
	...
	/**
	 * Convert the given IOException to an appropriate exception from the
