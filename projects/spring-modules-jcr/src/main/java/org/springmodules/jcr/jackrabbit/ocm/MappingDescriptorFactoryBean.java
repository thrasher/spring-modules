 ...
 * file descriptors and assembles them into an overall class descriptor.
 * 
 * @author Costin Leau
 * 
 */
public class MappingDescriptorFactoryBean implements FactoryBean,
	...
	public Class getObjectType() {
		return (this.mappingDescriptor != null) ? this.mappingDescriptor
				.getClass() : ClassDescriptor.class;
	}
	...
	public void afterPropertiesSet() throws Exception {
		if (mappings == null || mappings.length == 0)
			throw new IllegalArgumentException(
					"at least one mapping file is needed");

		createMappingDescriptor();
	}

	/**
	 * Subclasses can extend this method to provide custom behavior when
	 * creating the mapping descriptor
	 */
	protected void createMappingDescriptor() throws IOException,
			JcrMappingException {
		// load the descriptors step by step and concatenate everything in an
		// over-all
		// descriptor
